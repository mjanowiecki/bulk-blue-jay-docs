...
| title                         | parent                                        | position | repository      | resource                       | level | publish | suppressed | restrictions\_apply | repository\_processing\_note                                                                                                        | dates                                                                  | extents                                                                                               | linked\_agents                                                                     | subjects                       | digital\_objects                                                     | singlepart\_note                                                                                                                                | multipart\_note                                                                         | instances                                                                                                         |
|-------------------------------|-----------------------------------------------|----------|-----------------|--------------------------------|-------|---------|------------|---------------------|-------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|--------------------------------|----------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Audio recordings of blue jays | /repositories/3/archival\_objects/326200      | 1        | /repositories/3 | /repositories/3/resources/1821 | file  | True    | False      | False               |                                                                                                                                     | label==creation;;date\_type==inclusive;;begin==2003\-03;;end==2003\-12 | number==26;;portion==whole;;extent\_type==Items;;container\_summary==26 cassettes                     | role==creator;;ref==/agents/people/6453\|\|role==creator;;ref==/agents/people/6454 | /subjects/2437\|/subjects/2727 | ref==/repositories/3/digital_objects/15784;;is_representative==False |                                                                                                                                                 | type==arrangement;;publish==True;;content==Arranged by identified bird\.                |                                                                                                                   |
| Blue jay feathers             | /repositories/3/archival\_objects/326200 | 3        | /repositories/3 | /repositories/3/resources/1821 | file  | True    | False      | False               | Please note that the actual feathers are held by the Department of Biology and cannot be accessed\. This file is photographs only\. | label==creation;;date\_type==single;;begin==2003                       | number==175;;portion==whole;;extent\_type==photographic\_prints;;container\_summary==175 color photos | role==creator;;ref==/agents/people/6453\|\|role==creator;;ref==/agents/people/6454 | /subjects/2730\|/subjects/2727 | ref==/repositories/3/digital_objects/15783;;is_representative==False | type==physdesc;;publish==True;;content==175 photographs of 57 feathers\.                                                                        | type==arrangement;;publish==True;;content==Arranged by feather identifier\.             |                                                                                                                   |
...
??? note "instances"
    - ArchivesSpace field equivalent: Add Container Instance
    - Required in CSV: :x: False
    - Allows multiple values: :white_check_mark: True
    - Data type: [Subfield type](../workflow/2-fill-out-templates.md/#subfield-type)
    - Allowed subfields:
...
??? note "digital_objects"
    - ArchivesSpace field equivalent: Add Digital Object
    - Required in CSV: :x: False
    - Allows multiple values: :white_check_mark: True
    - Data type: [Subfield type](../workflow/2-fill-out-templates.md/#subfield-type)
    - Allowed subfields:
        - is_representative
            - ArchivesSpace field equivalent: Make Representative
            - Required in field: :x: False
            - Data type: [Boolean](../workflow/2-fill-out-templates.md/#boolean)
        - ref
            - ArchivesSpace field equivalent: Digital Object
            - Required in field: :white_check_mark: True
            - Data type: [Ref](../workflow/2-fill-out-templates.md/#ref)
    - Example: `ref==/repositories/3/digital_objects/15783;;is_representative==False`
